...
// Той самий алгоритм нормалізації телефону, що і на клієнті (register2.html) та в
// api/telegram-auth.js: лишаємо тільки цифри, щоб формат завжди збігався.
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const profResp = await fetch(
      `${SUPABASE_URL}/rest/v1/profiles?phone=eq.${encodeURIComponent(phone)}&select=user_id`,
